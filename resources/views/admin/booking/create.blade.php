...
@section('page_title', 'Pages / Booking ' . $lapangan->nama)
...
<div class="bg-white p-6 rounded-lg shadow">
        ...
        <div class="flex items-center space-x-3">
            <a href="{{ route('booking.index') }}" 
               class="inline-flex items-center px-4 py-2 border border-transparent text-sm font-medium rounded-md shadow-sm 
                      text-white bg-blue-500 hover:bg-blue-600 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500 transition duration-150">
                Kembali
            </a>
    ...
    <form id="bookingForm" action="{{ route('booking.store', $lapangan) }}" method="POST" class="space-y-4">
        @csrf
