    ...
    <div class="mb-8 flex flex-col sm:flex-row sm:items-end justify-between gap-4">
        <div>
            ...
            <p class="text-sm text-gray-500">
                Daftar lengkap riwayat peminjaman lapangan dari semua user.
            </p>
        </div>

        <!-- Tombol Export (Hanya Tampilan) -->
        <div>
            <button type="button" class="inline-flex items-center gap-2 px-4 py-2 bg-emerald-600 hover:bg-emerald-700 text-White text-sm font-medium rounded-lg transition-colors shadow-sm focus:outline-none focus:ring-2 focus:ring-emerald-500 focus:ring-offset-2">
                            ...
                            <tr class="hover:bg-gray-50/50 transition-colors group">
                                ...
                                <td class="px-6 py-4 whitespace-nowrap">
                                    <div class="flex flex-col">
                                        <span class="text-sm font-bold text-gray-900">{{ $r->nama_pemesan ?? 'User' }}</span>
                                        <span class="text-xs text-gray-400">ID Booking: #{{ $r->id }}</span>
                                    </div>
                                </td>
