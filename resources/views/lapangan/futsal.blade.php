@extends('layouts.app')
@section('page_title', 'Pages / Futsal')

@section('header')
<h2 class="font-semibold text-xl text-gray-800 leading-tight">
    Form Peminjaman Lapangan Futsal
</h2>
@endsection

@section('content')
<div class="bg-white p-6 rounded-lg shadow">
    <h2 class="text-xl font-bold mb-6">Form Peminjaman Lapangan Futsal</h2>
    ...
    <form id="futsalForm" action="{{ route('futsal.store') }}" method="POST" class="space-y-4">
        @csrf
            ...
            .then(({status, body}) => {
                if (status === 200) {
                    Swal.fire({
                        icon: 'success',
                        title: 'Berhasil!',
                        text: body.message || 'Pemesanan lapangan futsal berhasil diajukan!',
                        confirmButtonColor: '#0ea5e9'
                    });
                    form.reset();
                } else {
