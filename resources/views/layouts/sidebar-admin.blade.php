<div class="flex flex-col h-full bg-white text-gray-700 transition-all duration-300 shadow-xl rounded-2xl overflow-hidden"
    ...
    <div class="mt-auto w-full px-3 pb-4 pt-4 space-y-1 border-t border-gray-200">
        ...
        <!-- Help
        <a href="#"
           class="flex items-center w-full h-12 px-3 rounded-xl transition-all duration-200 hover:bg-gray-100 text-gray-600 hover:text-gray-900"
           :class="!sidebarOpen ? 'justify-center' : ''">
            ...
            <span x-show="sidebarOpen" class="ml-3 text-sm font-medium whitespace-nowrap">Help</span>
        </a> -->
