...
<div class="grid grid-cols-1 lg:grid-cols-3 gap-6">
    <div class="lg:col-span-2 bg-white shadow-lg rounded-xl p-6">
        ...
        @if (($totalBookings ?? 0) > 0)
            <div class="space-y-6">
                @foreach ($fieldDetails as $field)
                    @php
                        $percentage = round(($field['bookings'] / $totalBookings) * 100, 1);
                    @endphp
                    ...
                    <div class="mb-4">
                        ...
                        <div class="w-full bg-gray-200 rounded-full h-3">
                            <div class="h-3 rounded-full bg-{{ $field['color'] }}-500 transition-all duration-700 ease-out" 
        ...
        @else
            <p class="text-gray-500">Belum ada data pemesanan yang disetujui tercatat bulan ini.</p>
        @endif
    </div>
