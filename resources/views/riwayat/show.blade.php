...
@section('content')
{{-- Wrapper: Padding lebih kecil di mobile (p-4) --}}
<div class="min-h-screen bg-gray-50 p-4 md:p-8">
    ...
    <div class="max-w-4xl mx-auto grid grid-cols-1 md:grid-cols-3 gap-6">
        ...
        {{-- Kolom Kiri: Informasi Utama (2/3 lebar di desktop) --}}
        ...
        {{-- Kolom Kanan: Aksi & Info (1/3 lebar di desktop) --}}
        <div class="space-y-6">
            
            {{-- Card Aksi --}}
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-6">
                <h3 class="text-xs md:text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Aksi</h3>
            ...
            <div class="bg-white rounded-2xl shadow-sm border border-gray-100 p-5 md:p-6">
                <h3 class="text-xs md:text-sm font-bold text-gray-900 uppercase tracking-wide mb-4">Informasi</h3>
